        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="reset_psw.php" method="POST" name="login" onsubmit="return validateForm()">
...
<?php
    if(isset($_POST["reset"])){
        ...
        if($Email){
            $new_pass = $hash;
            mysqli_query($conex, "UPDATE clientes SET passCliente='$new_pass' WHERE correo='$Email'");
