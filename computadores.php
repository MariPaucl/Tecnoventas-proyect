...
<body>
	<div class="head">
		...
		<?php foreach($resultado as $row) { ?>
			<li><a href="detailsCom.php?codProd=<?php echo $row['codProd'];?>&token=<?php echo hash_hmac('sha1', $row['codProd'], KEY_TOKEN);?>"><i class="fa-solid fa-magnifying-glass" ><?php echo $row['nomProd']?></i></a></li>
			<?php } ?>
		</ul>
