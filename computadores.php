...
FROM productos p INNER JOIN infoproductos i ON p.codProd = i.codProd WHERE p.codigoCat = 3
...
<script src="Productos_Cliente/cell/index.js"></script>
		...
		<script src="js/cartcom.js"></script>
...
<body>
	<div class="head">
		...
		<?php foreach($resultado as $row) { ?>
			<li><a href="detailsCom.php?codProd=<?php echo $row['codProd'];?>&token=<?php echo hash_hmac('sha1', $row['codProd'], KEY_TOKEN);?>"><i class="fa-solid fa-magnifying-glass" ><img src="img/lupa2.png" alt="" ><?php echo $row['nomProd']?></i></a></li>
			<?php } ?>
		</ul>
	...
	<body>
		...
		<div class="pro">
			<div class="filtro">
				...
				<div class="h2">Capacidad de Disco</div>
				<hr class="l2">
				<div>
