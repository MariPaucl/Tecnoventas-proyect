    ...
    function updateCartItem(rowid, qty){
        $.get("AccionCarta.php", {action: "updateCartItem", rowid: rowid, qty: qty}, function(data){
            if(data == 'ok'){
                ...
                alert('Error al actualizar el carrito, por favor intente de nuevo.');
            }
        });
    }
    </script>
                    ...
                    <tbody>
                        ...
                        ?>
                                <tr>
                                    ...
                                    <td><input type="number" value="<?php echo $item['qty']; ?>" onchange="updateCartItem('<?php echo $item['rowid']; ?>', this.value)"></td>
