...
<?php
    if(isset($_POST["recover"])){
        ...
        if(mysqli_num_rows($sql) <= 0){
            ...
            $mail->Body="<b>Querido Administrador</b>
            <h3>Hemos recibido una solicitud para recuperar tu contraseña.</h3>
            <p>Has click <a href='http://localhost/Tecnoventas-proyect/recuperaPswAdmin/reset_Admin.php'>Aquí</a> para cambiar tu contraseña</p>
            <br><br>
            <p>Atentamente,</p>
            <b>Tecnoventas</b>";
            ...
            if(!$mail->send()){
                ...
                ?>
                    <script>
                        window.location.replace("../recuperaPsw/notificacion.html");
                    </script>
                <?php
                $_SESSION['correoAdmin'] = $email;
            }
