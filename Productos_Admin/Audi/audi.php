...
$sql = $con->prepare("SELECT codProd, imagen, nomProd, precio, estProd FROM productos WHERE codigoCat = 5");
$sql->execute();
...
<nav class="navbar navbar-expand navbar-dark bg-dark">
        ...
        <li class="nav-item">
        <a class="nav-link active" href="../Comp/comp.php">Computadores</a>
        </li>
        <li class="nav-item">
