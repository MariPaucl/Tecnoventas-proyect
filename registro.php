    ...
    <div class="container">
        ...
        <form id="form" class="form" method="post" onsubmit='return validarForm()'>
            ...
            <div  class="form-control">
					...
					<input maxlength="10" minlength="1" oninput="this.value = this.value.replace(/[^0-9]/g, '');" type="text" placeholder="N° Documento" id="documento" name="numId" />
					<i class="fas fa-check-circle"></i>
					<i class="fas fa-exclamation-circle"></i>
					<small>Error message</small>
				</div>
				...
				<div  class="form-control">
					...
					<input maxlength="20" minlength="1" oninput="this.value = this.value.replace(/[^A-Za-z]/g, '');" type="text" placeholder="Nombre" id="Nombres" name="nombre"/>
					<i class="fas fa-check-circle"></i>
					<i class="fas fa-exclamation-circle"></i>
					<small>Error message</small>
				</div>
				...
				<div  class="form-control">
					...
					<img src="registro/persona.png"/>
					<input maxlength="20" minlength="1" oninput="this.value = this.value.replace(/[^A-Za-z]/g, '');" type="text" placeholder="Apelido" id="Apellidos" name="apellido"/>
					<i class="fas fa-check-circle"></i>
					<i class="fas fa-exclamation-circle"></i>
					<small>Error message</small>
				</div>
			...
			<div class="form-control">
                ...
                <input maxlength="10" minlength="1" oninput="this.value = this.value.replace(/[^0-9]/g, '');" type="text" placeholder="Numero de Telefono" id="cell" name="telefono" />
                <i class="fas fa-check-circle"></i>
                <i class="fas fa-exclamation-circle"></i>
                <small>Error message</small>
            </div>
			...
			<p>¿Ya tienes cuenta? <a class="link" href="sesion.html">Inicia Sesión</a></p>
        </form>
    </div>
